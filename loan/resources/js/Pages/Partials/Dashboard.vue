                                            ...
                                            <div class="card-spacer mt-n25">
                                                ...
                                                <div class="row m-0">
                                                    <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                                        ...
                                                        <a href="#" class="text-warning font-weight-bold font-size-h6">Weekly Loans</a>
                                                    </div>
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="#" target="_blank" class="text-dark-75 text-hover-primary">Flex Pay Credit Loans</a>
                        </div>
                        <!--end::Copyright-->
                    </div>
                    <!--end::Container-->
...
import KTHeader from "../layout/header/Header";
export default {
    components:{
      AppLayout,
      MobileHeader,
    ...
    mounted() {
        // var chart = new ApexCharts(document.querySelector('#chart_1'), this.options)
        // chart.render();
        // let recaptchaScript = document.createElement('script')
        // recaptchaScript.setAttribute('src', '/assets/js/jquery-3.4.1.min.js')
